...
{
    public class EnemyWeapon_HomingRifle : Game_EnemyWeapon
    {
        public override Type realType { get; } = typeof(EnemyWeapon_HomingRifle);
        public EnemyWeapon_HomingRifle(int ownerID, float OffsetX = 0, float OffsetY = 0)
